...
const byte PIN_IRQ_WIND_SPEED = 6;
const byte PIN_IRQ_RAIN = 5;

const byte PIN_LED_BLUE = 12;
const byte PIN_LED_RED = 13;
const byte PIN_GPS_POWER = 9;
...
void setup() {
    ...
    attachInterrupt(digitalPinToInterrupt(PIN_IRQ_RAIN), irq_handler_rain, FALLING);
    attachInterrupt(digitalPinToInterrupt(PIN_IRQ_WIND_SPEED), irq_handler_wind_speed, FALLING);
...
#define PRINT_LABEL(label)                  Serial2.print(",")
#define PRINT_VALUE_FLT(value, decimals)    Serial2.print(value, decimals)
#define PRINT_VALUE_INT(value)              Serial2.print(value)
